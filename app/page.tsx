    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-lg overflow-hidden bg-white/10 backdrop-blur-sm">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%201%20de%20ago.%20de%202025%2C%2010_58_14-PTsfi4crqt0VoPCXP8zAUKoLFdaBpx.png"
                  alt="Brazil S.A Logo"
      ...
      <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/1316643-cwrUxLhJ0BnT5v2TuuLFj5kIlTnXpo.jpeg')",
